...
<div
    class="na-segment-control"
    class:na-segment-control--sm={size === "sm"}
    class:na-segment-control--stretch={stretch}
    role="radiogroup"
...
<style lang="scss">
    ...
    .na-segment-control--stretch .na-segment-control__option {
        flex: 1;
    }
