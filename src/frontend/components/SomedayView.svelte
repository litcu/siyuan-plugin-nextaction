...
<NaViewShell loading={$taskStore.loading} empty={filteredTasks.length === 0} emptyText={$taskStore.error || i18n?.noSomedayTasks || "No Someday/Maybe tasks"} hint={i18n?.viewHintSomeday}>
