...
<NaViewShell loading={$taskStore.loading} empty={filteredTasks.length === 0} emptyText={searchText ? (i18n?.noResults || "No matching tasks") : (i18n?.noTasks || "No tasks yet")} scrollMode="none">
