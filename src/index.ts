...
export default class NextActionPlugin extends Plugin {
    ...
    <path d="M24 8l3 0 0 3" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        this.addTab({
            ...
            init() {
                ...
                void import("./frontend/components/NextActionApp.svelte").then(({ default: NextActionApp }) => {
    ...
    openSetting(): void {
        ...
        void import("./frontend/components/SettingsPanel.svelte").then(({ default: SettingsPanel }) => {
